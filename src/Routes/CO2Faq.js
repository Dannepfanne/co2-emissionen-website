  ...
  return (
    <Accordion defaultActiveKey="0">
      <Accordion.Item eventKey="0">
        <Accordion.Header>Warum ist der CO2-Ausstoß wichtig?</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>
          Erneuerbare Energien wie Solarenergie und Windkraft produzieren Strom
          ohne CO2-Emissionen. Durch den Übergang von fossilen Brennstoffen zu
          erneuerbaren Energien kann ein Land seinen CO2-Ausstoß erheblich
          reduzieren.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="3">
        ...
        <Accordion.Body>
          Der CO2-Ausstoß führt zu Klimawandel, der wiederum zu extremeren
          Wetterereignissen, Meeresspiegelanstieg und Veränderungen in
          Ökosystemen führt. Dies beeinträchtigt die Tier- und Pflanzenwelt
      ...
      <Accordion.Item eventKey="4">
        ...
        <Accordion.Body>
          ...
          für Länder, um den globalen Temperaturanstieg zu begrenzen. Es fördert
          die Zusammenarbeit zwischen Ländern, um den CO2-Ausstoß zu reduzieren.
        </Accordion.Body>
      </Accordion.Item>
