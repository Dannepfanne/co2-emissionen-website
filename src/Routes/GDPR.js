  ...
  return (
    <div>
      ...
      <p>
        ...
        oder sie für den Zweck nicht erforderlich sind). Sofern die Daten nicht
      ...
      <ul>
        ...
        <li>
          ...
          davon ausgehen, dass Cookies permanent sind und die Speicherdauer bis
      ...
      <ul className="m-elements">
        ...
        <li>
          ...
          können zum einen zu Zwecken der Sicherheit eingesetzt werden,
          z.&nbsp;B., um eine Überlastung der Server zu vermeiden (insbesondere
